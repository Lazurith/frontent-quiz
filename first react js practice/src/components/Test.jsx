...
function Test({ questions: { color, icon, questions, title } }) {
    ...
    const handleNextQuestion = () => {
        ...
        setQuestionIndex(answeredQuestions + 1)
    ...
    return (
        <div className="test-container">
            <div className="test-content">
                <p className="test-description"> {`Question ${answeredQuestions}
                    of ${questions.length} `}</p>
                <h2 className="test-title">
                    {questions[questionIndex].question}
                </h2>
                <div className="test-proccess-container">
                    <div className="test-proccess" style={{
                            ...
                            return (
                                <li key={option}>
                                    <label className={`test-label ${className}`}>
                                        ...
                                        {/* icon */}
                                        <img className="test-icon-correct"
                                            src="../assets/icon-correct.svg" alt="icon"
                                            width={40} height={40} />
                                        <img className="test-icon-incorrect"
                                            src="../assets/icon-incorrect.svg" alt="icon"
                                            width={40} height={40} />
                                    </label>
                                </li>
                            );
